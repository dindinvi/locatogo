        ...
        var name = document.getElementById('fos_user_registration_form_personne_lastname') ;
        name.addEventListener('keyup',function(e) {
                                       n = document.getElementById('fos_user_registration_form_personne_lastname') ;
                                        if (n.value.length >= 2) {
                                             n.className= '';
                                        } else {

                                             n.className= 'alert-danger';
                                        }
                                }, false);
      var first = document.getElementById('fos_user_registration_form_personne_firstname') ;
        first.onkeyup=function(e) {
...
check['age'] = function() {
var age = document.getElementById('age'), tooltipStyle = getTooltip(age).style, ageValue = parseInt(age.value);
...
var myForm = document.getElementById('myForm'), inputs = document.getElementsByTagName('input'),
